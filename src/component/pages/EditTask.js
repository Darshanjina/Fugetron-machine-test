...
export default class EditTask extends Component {
  ...
  funHandleSubmit=(e)=>{
    axios.get("https://o1wm686yz2.execute-api.us-east-1.amazonaws.com/v1/edit",{params:{
      ...
      <div className="container">
        <div className="row py-3">
          ...
          <div className="col-3">
            ...
            <input type="email" name="email" disabled className="form-control" onChange={this.funHandleChange} value={this.state.email}/>
          </div>
        ...
        <button className="btn btn-primary btn-sm rounded-pill mr-2 px-4" onClick={this.funValidation}>Update</button>
